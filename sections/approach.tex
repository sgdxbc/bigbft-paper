...
We highlight two insights that enables scalability while maintaining state availability.
...
Given that the typical working sets of blockchain workloads are a small constant, the computational overhead of symbol decoding in erasure coding can be effectively masked by caching techniques.
