...
To retrieve a value of a key, the replica nodes need to reconstruct the entire shard first, which incurs significant computation and communication overhead.
On the other hand, replication can maximize the efficiency of online retrieval.
To ensure the correctness of the retrieved values, we manage the shard with a binary Merkle tree.
...
The root hash of the tree, called \emph{shard commitment}, is stored by the replica nodes for verification.
