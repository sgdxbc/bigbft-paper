...
Correctness of state management relies on the guarantees of the consensus and the execution layers.
...
\begin{itemize}
    ...
    \item \textbf{State availability}: Every \fetch and \bump call issued by a correct replica node returns eventually.
\end{itemize}
