...
In the contrary, the processing sharding design of the compared works disables sharding with committee sizes smaller than hundreds, not even mention that it also compromises the security properties (\autoref{sec:bg}).
...
We analyze a skewed workload that access few shards per transaction, and specific plotting equation and the detailed parameters are presented in the appendix.
